...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 65024;
    ...
    const char CRYPTONOTE_NAME[] = "Nakamoto";
    ...
    const char LATEST_VERSION_URL[] = "http://latest.nakzone.com";

    const std::string LICENSE_URL = "https://github.com/nakamoto/nakamoto/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb1, 0x1c, 0x3a, 0x6c, 0xcf, 0x12, 0x13, 0x11, 0x15, 0xf2, 0x12, 0xa1, 0xb8, 0xc4, 0x22, 0xe1}};

    const char *const SEED_NODES[] = {
        "185.206.213.200:11897", // rock
        "185.206.213.196:11999", // cision
        "185.206.213.195:11897"
    };
} // namespace CryptoNote
